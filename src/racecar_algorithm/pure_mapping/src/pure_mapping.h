...
class PureMapping
{
  public:
    PureMapping();
    PureMapping(ros::NodeHandle& nh, ros::NodeHandle& pnh);
    PureMapping(unsigned long int seed, unsigned long int max_duration_buffer);
    ~PureMapping();
  ...
  private:
    ...
    std::vector<GMapping::RangeReading> reading_buffer_;
