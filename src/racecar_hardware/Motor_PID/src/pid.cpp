...
PidObject::PidObject() : error_(3, 0), filtered_error_(3, 0), error_deriv_(3, 0), filtered_error_deriv_(3, 0)
{
  ...
  node_priv.param<std::string>("topic_from_controller", topic_from_controller_, "Motor_pid_Out_std_msgs");
  node_priv.param<std::string>("topic_from_plant", topic_from_plant_, "odom_speed_std_msgs");
  node_priv.param<std::string>("setpoint_topic", setpoint_topic_, "ackermann_std_msgs");
